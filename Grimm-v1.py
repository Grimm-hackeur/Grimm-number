...
# ========================
# MODULE TEMPMAIL (utilisant 1secmail.com)
# ========================
def tempmail():
    banner()
    print("[+] Génération d’un email temporaire sécurisé...\n")
    # Génération aléatoire du nom d'utilisateur
    ...
    # Boucle de vérification de la boîte de réception
    while True:
...
def numero_virtuel():
    ...
    try:
        ...
        print(f"\n[+] En attente de code pour {service}... (Appuyez sur [1] pour rafraîchir, [2] pour quitter)")
        ...
        while True:
            ...
            if not messages:
                ...
                for msg in messages[:5]:  # affiche les 5 messages les plus récents
        ...
        print(f"[!] Une erreur est survenue lors de la récupération des numéros : {e}")
